...
import { seededShuffle } from '@/features/explore/hooks/useDailyLayout';
...
export default function TopTracksSection({ refreshKey = 0 }: Props) {
                ...
                {page.map(song => (
                  ...
                  >
                    ...
                    <View style={styles.info}>
                      ...
                      <Text style={[styles.trackArtist, isDarkMode && styles.trackArtistDark]} numberOfLines={1}>
                        {song.artist}
                      </Text>
                    </View>
                    <TouchableOpacity
